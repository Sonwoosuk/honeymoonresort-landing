...
(function () {
  ...
  // 이미지 목록 — 허니문리조트 목적지 사진
  var IMG_BASE = '/honeymoonresort-landing/assets/destinations/';
  var STORY_IMAGES = [
    IMG_BASE + 'hawaii.jpg',
    IMG_BASE + 'maldives.jpg',
    IMG_BASE + 'europe.jpg'
  ];
  ...
  function initKakaoMap() {
    ...
    var mapContainer = document.getElementById("map");
      ...
      var markers = {
        seoul: new kakao.maps.Marker({ position: coords.seoul, map: map, title: "허니문리조트 서울" }),
        andong: new kakao.maps.Marker({ position: coords.andong, map: map, title: "허니문리조트 서울" })
      };
      var infoWindows = {
        seoul: makeInfoWindow("허니문리조트 서울 본사"),
        andong: makeInfoWindow("허니문리조트 서울 본사")
      };
