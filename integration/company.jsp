...
/* -------------------------------------------------------------
   4-0. 싱글 풀블리드 히어로 (사진 1장 + 겹치는 대형 헤드라인)
------------------------------------------------------------- */
.hero__single {
  position: relative;
  width: 100%;
...
@media (max-width: 860px) {
  .hero__single { height: auto; min-height: 0; aspect-ratio: 3 / 4; }
  .hero__single-card { position: static; max-width: none; margin: 0; box-shadow: none; padding: 22px 20px; }
  .hero__single-title { position: absolute; }
}
...
<section class="hero">
  ...
  <div class="hero__single">
    <img src="../new_ver/img/company-intro/hero-main.jpg" alt="허니문리조트 몰디브 디가리 리조트 전경">
    <p class="hero__single-title">1995년부터,<br>신혼여행을<br>전문으로</p>
    <div class="hero__single-card">
      <p class="hero__single-desc">예비부부의 예산과 여행 스타일에 맞춰 항공·호텔·투어·현지 일정을 함께 구성합니다.</p>
      <a href="#" class="hero__single-cta">1:1 무료 상담</a>
    </div>
  </div>
