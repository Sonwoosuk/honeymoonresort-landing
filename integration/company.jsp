...
.hero__intro p {
  ...
  text-align: justify;
  text-align-last: left; /* 각 <br> 앞 마지막 줄만 늘어나지 않고 자연스럽게 왼쪽 정렬 */
}
...
/* 짧은 블러브(process/브랜드/안전 인트로, <br>로 미리 2줄 나눠둔 유튜브·셀럽
   문단)는 text-align:center 그대로가 깔끔함. "검증된 회사" 섹션 문단만 <br> 없이
   자연스럽게 줄바꿈되는 진짜 긴 문단(3~4줄)이라 줄마다 길이가 들쭉날쭉해
   버섯 모양처럼 보이므로, 여기만 양쪽 정렬(justify)로 좌우 끝을 맞춤 */
.verified__intro p {
  text-align: justify;
...
<section class="celeb">
  ...
  <div class="celeb__inner">
    <div class="text-stack celeb__note">
      <p>다양한 유명인 및 스포츠 선수의 허니문을 상담·진행한 경험 역시<br>맞춤형 신혼여행 운영 경험을 보여주는 사례입니다.</p>
