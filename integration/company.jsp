...
/* -------------------------------------------------------------
   4-0. 스플릿 듀얼 이미지 히어로 (풀와이드, 겹치는 대형 헤드라인)
------------------------------------------------------------- */
.hero__split {
  position: relative;
  width: 100%;
...
.hero__split-cta {
  ...
  color: var(--hero-color-on-accent);
  font-weight: 700;
  font-size: 14px;
  white-space: nowrap;
...
@media (max-width: 860px) {
  .hero__split { height: auto; min-height: 0; }
  .hero__split-media { position: relative; flex-direction: column; height: 60vh; }
  .hero__split-copy { position: absolute; inset: 0; padding: 0 20px; }
  .hero__split-foot { flex-direction: column; align-items: flex-start; }
}
...
/* 5단계 스텝: 채워진 원형 숫자 + 라벨, 화살표로 흐름 연결 */
.process__steps {
  position: relative;
  display: flex;
  justify-content: space-between;
...
/* 마지막 스텝을 제외하고 오른쪽에 화살표로 다음 단계와 연결
   (숫자 원(64px) 절반 = 32px 지점이 숫자 원의 세로 중심) */
.process__step:not(:last-child)::after {
  ...
  font-size: 20px;
  color: var(--hero-color-gold-soft);
}
...
<section class="hero">
  ...
  <div class="hero__split">
    <div class="hero__split-media">
      <div class="hero__split-half">
        <img src="../new_ver/img/company-intro/destinations/hawaii.jpg" alt="하와이 신혼여행">
      </div>
      <div class="hero__split-half">
        <img src="../new_ver/img/company-intro/destinations/maldives.jpg" alt="몰디브 신혼여행">
      </div>
    </div>
    <div class="hero__split-copy">
      <p class="hero__split-title">1995년부터,<br>신혼여행을<br>전문으로</p>
      <div class="hero__split-foot">
        <p class="hero__split-desc">예비부부의 예산과 여행 스타일에 맞춰<br>항공·호텔·투어·현지 일정을 함께 구성합니다.</p>
        <a href="#" class="hero__split-cta">1:1 무료 상담</a>
      </div>
    </div>
  </div>
