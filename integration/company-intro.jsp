...
<section class="hero">
  <div class="hero__inner">
    ...
    <div class="hero__header">
      <h1 class="hero__logo">
        <!-- 실제 브랜드 로고 (assets/logo/honeymoonresort-logo.png) -->
        <img class="hero__logo-image" src="../../new_ver/img/company-intro/logo/honeymoonresort-logo.png" alt="허니문리조트 Honeymoon Resort">
      </h1>
    </div>
...
<section class="youtube">
  <div class="youtube__inner">
    ...
    <div class="youtube__videos">
      ...
      -->
      <a class="youtube__video-thumb" href="https://youtu.be/p092MZ6-ZU4" target="_blank" rel="noopener">
        <img class="youtube__video-image" src="https://img.youtube.com/vi/p092MZ6-ZU4/maxresdefault.jpg" alt="이탈리아 신혼여행 아말피 & 포지타노 호텔 리뷰 | 벨몬드 카루소 | 산타 카테리나">
        <span class="youtube__play" aria-hidden="true"></span>
      </a>
      <a class="youtube__video-thumb" href="https://youtu.be/3MfFgieS6Yk" target="_blank" rel="noopener">
        <img class="youtube__video-image" src="https://img.youtube.com/vi/3MfFgieS6Yk/maxresdefault.jpg" alt="스페인 마요르카 신혼여행 주메이라 마요르카 전 객실 리뷰 및 주변 관광지">
        <span class="youtube__play" aria-hidden="true"></span>
      </a>
      <a class="youtube__video-thumb" href="https://youtu.be/bb41Sjrf4-M" target="_blank" rel="noopener">
        <img class="youtube__video-image" src="https://img.youtube.com/vi/bb41Sjrf4-M/maxresdefault.jpg" alt="몰디브 신혼여행 vlog 포시즌스 란다기라바루 하이엔드 리조트 체험기 1편">
        <span class="youtube__play" aria-hidden="true"></span>
      </a>
    </div>
...
<section class="safety">
  <div class="safety__inner">
    ...
    <div class="safety__badges">
      <span class="safety__badge">일반여행업 보증</span>
      <span class="safety__badge">기획여행업 보증</span>
      <span class="safety__badge">여행업자 배상책임보험</span>
      <span class="safety__badge">IATA BSP 7억 원</span>
      <span class="safety__badge">Expedia TAAP Platinum Tier</span>
    </div>
