...
<%-- TODO(모바일): 아래 header/footer include 경로를 실제 /m/ 레이아웃 파일로 교체하세요
     (예: ../m/layout/header.jsp 등). 현재는 PC 버전과 동일한 경로로 두었습니다. --%>
